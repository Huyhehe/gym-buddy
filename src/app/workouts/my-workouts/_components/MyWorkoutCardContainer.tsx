...
export const MyWorkoutCardContainer = () => {
  ...
  return (
    <div className="grid grid-cols-12 gap-4 @container">
      ...
      <Stack
        className="col-span-12 aspect-square cursor-pointer items-center justify-center rounded-lg bg-white shadow-md transition-all duration-300 ease-in-out hover:scale-90 hover:bg-gray-200 @4xl:col-span-6 @6xl:col-span-4 @[1280px]:col-span-3"
